...
exports.send = exports.hydrateTemplate = exports.getInputVariables = exports.resolveVariables = exports.getDefaultVariables = void 0;
const https_1 = __nccwpck_require__(687);
/**
...
function resolveVariables(input) {
    const parsedSummary = JSON.parse(input);
...
async function main() {
    ...
    const resolvedVariables = (0, helpers_1.resolveVariables)((0, core_1.getInput)('summary'));
    const variables = inputVariables.concat(defaultVariables, resolvedVariables);
